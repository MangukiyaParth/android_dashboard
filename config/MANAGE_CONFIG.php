...
if (IS_PRODUCTION) {
    ...
    define("API_SERVICE_URL", "http://" . $_SERVER['HTTP_HOST'] . "/HTML/android_dashboard/api_services/");
    define("ADMIN_PANEL_URL", "http://" . $_SERVER['HTTP_HOST'] . "/HTML/android_dashboard/");
    define("ROOT_URL", "http://" . $_SERVER['HTTP_HOST'] . "/HTML/android_dashboard/");
