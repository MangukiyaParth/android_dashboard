...
include_once __DIR__."/config/gatter_satter.php";
...
var PDF_ICON="' . ADMIN_PANEL_URL . 'assets/images/PDF_file_icon.png";
var IMG_ICON="' . ADMIN_PANEL_URL . 'assets/images/img_icon.png";
var petrol_fule_id = "' . $const->petrol_fule_id . '";
var diesel_fule_id = "' . $const->diesel_fule_id . '";
var ev_fule_id = "' . $const->ev_fule_id . '";
var hybrid_fule_id = "' . $const->hybrid_fule_id . '";
...
<head>
	...
	<link href="<?php echo ADMIN_PANEL_URL; ?>assets/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
		...
		<?php if ($current_user_id != "" && !in_array($current_page, $login_not_needed_pages) && !in_array($current_page, $header_not_needed_pages)) { ?>
			...
			<div class="navbar-custom topnav-navbar pe-0">
				<div class="container-fluid detached-nav ps-4 pe-0">
					...
					<button class="button-toggle-menu button-toggle-menu-mobile">
					...
					<ul class="list-unstyled topbar-menu float-end mb-0 d-none">
					...
					<div class="action-btn d-none">
						<button class="btn btn-info" id="addBtn" onclick="changeView('form')"> Add </button>
						<button class="btn btn-info" id="backBtn" onclick="changeView('details')" style="display: none;"> Back </button>
					</div>
				</div>
			</div>
